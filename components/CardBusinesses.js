        ...
        <article className="max-w-96 flex flex-col shadow-2xl p-1">
            <div className="relative max-h-80 group overflow-hidden ">
                {loading ? <>
                    ...
                    :
                    <Link href={path + enlace} target="_blank" className="">
            ...
            <div className="p-1 flex flex-col justify-around gap-1 ">
                <Link href={path + enlace} target="_blank" className=""><h1 className="font-bold hover:text-blue-700 duration-200 text-xl title text-center">
                    {name}</h1></Link>
