...
const SocialMediaButton = ({ url }) => {
    switch (true) {
        ...
        case url?.includes('tiktok'):
            ...
            return (<a className="text-muted-foreground bg-gradient-to-r from-[#69C9D0] via-[#EE1D52] to-[#010101] flex gap-2 border-2 rounded-xl p-3 hover:text-foreground" href={url} rel="ugc">
